...
GetWeatherDetails getWeatherDetailsFromJson(String str) => GetWeatherDetails.fromJson(json.decode(str));

String getWeatherDetailsToJson(GetWeatherDetails data) => json.encode(data.toJson());
...
class GetWeatherDetails {
    ...
    factory GetWeatherDetails.fromJson(Map<String, dynamic> json) => GetWeatherDetails(
